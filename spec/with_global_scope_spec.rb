...
describe WithGlobalScope do
  ...
  describe "execution" do
    it "should execute the block given" do
      ...
      with_global_scope = WithGlobalScope.new(:foo, 1)
    ...
    it "should scope a query by the value given" do
      with_global_scope = WithGlobalScope.new(:first_name, "scott")
    ...
    it "should use the value given" do
      with_global_scope = WithGlobalScope.new(:first_name, "stephen")
    ...
    it "should scope by the variable given" do
      with_global_scope = WithGlobalScope.new(:last_name, "taylor")
    ...
    it "should not scope a model which does not respond to the column" do
      with_global_scope = WithGlobalScope.new(:foo, "bar")
